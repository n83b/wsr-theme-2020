...
/* harmony import */ var react_burger_menu_lib_menus_scaleDown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-burger-menu/lib/menus/scaleDown */ "./node_modules/react-burger-menu/lib/menus/scaleDown.js");
/* harmony import */ var react_burger_menu_lib_menus_scaleDown__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react_burger_menu_lib_menus_scaleDown__WEBPACK_IMPORTED_MODULE_2__);



const siteURL = 'http://dev.test.com';

class WSRMenu extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  constructor(props) {
    super(props);
    this.state = {
      menu: []
  ...
  componentDidMount() {
    fetch(siteURL + '/wp-json/wsr/menu').then(res => res.json()).then(result => {
      this.setState({
        menu: result
      });
    });
  ...
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_burger_menu_lib_menus_scaleDown__WEBPACK_IMPORTED_MODULE_2___default.a, {
      right: true,
      pageWrapId: "page-wrap",
      outerContainerId: "body"
    }, this.state.menu.map(item => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
      id: item.ID,
      className: "menu-item",
      href: item.url
    }, item.title)));
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WSRMenu, null), document.getElementById("wsr-menu"));
